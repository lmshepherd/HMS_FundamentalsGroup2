...
{
	public function appt_created_notification($appt)
	{
		...
		$this->email->from('admin@healtherecords.com','Appointment Notification');
		$this->email->to($pemail);
		$this->email->subject('Appointment Scheduled!');	
		//set up contents of email message
		$msg='<p>Your appointment with Dr. '.$doctor.' has been scheduled!</p>'; 
		$msg.='<p>Date: '.$date.'</p>';
		$msg.='<p>Time: '.$time.' '.$ampm.'</p>';
		...
		$this->email->subject('Appointment Scheduled!');
		//set up contents of email message
		$msg='<p>An appointment with '.$patient.' has been scheduled!</p>';
		$msg.='<p>Date: '.$date.'</p>';
		$msg.='<p>Time: '.$time.' '.$ampm.'</p>';
		$this->email->message($msg);
		$this->email->send();
		...
		$this->email->subject('Appointment Scheduled!');
		//set up contents of email message
		$msg='<p>An appointment with '.$patient.' for Dr. '.$doctor.' has been scheduled!</p>';
		$msg.='<p>Date: '.$date.'</p>';
		$msg.='<p>Time: '.$time.' '.$ampm.'</p>';
		$this->email->message($msg);
		$this->email->send();
	...
	public function appt_cancelled_notification($appt)
	{
		//get appt info from db
		$this->db->where('appt_id',$appt);
		$query = $this->db->get('appts');
		...
		$this->email->set_newline("\r\n");
		//set up email to be sent
		$this->email->from('admin@healtherecords.com','Appointment Cancellation');
		$this->email->to($pemail);
		$this->email->subject('Appointment Cancellation!');
		//set up contents of email message
		$msg='<p>Your appointment with Dr. '.$doctor.' has been cancelled!</p>';
		$this->email->message($msg);
		$this->email->send();
		...
		$this->email->subject('Appointment Cancellation!');
		//set up contents of email message
		$msg='<p>Your appointment with '.$patient.' has been cancelled!</p>';
		$this->email->message($msg);
		$this->email->send();
		...
		$this->email->subject('Appointment Cancellation!');
		//set up contents of email message
		$msg='<p>Your appointment time with '.$patient.' for Dr. '.$doctor.' has been cancelled!</p>';
		$this->email->message($msg);
		$this->email->send();
	}
